  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-[#111827]">Lecturer Attendance Records</h2>
        {attendance.length > 0 && (
          <button 
                ...
                <table className="w-full text-left">
                  ...
                  <tbody>
                    {groupedAttendance[date].sort((a, b) => new Date(a.timestamp).getTime() - new Date(b.timestamp).getTime()).map(record => (
                      <tr key={record.userId + record.timestamp} className="bg-white border-b border-gray-200 hover:bg-gray-50">
                        <td className="px-6 py-4 font-medium text-[#111827] whitespace-nowrap">{record.userName}</td>
